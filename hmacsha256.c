...
// MEATHOD SPACE???
static void hmacsha256_symbol(t_hmacsha256 *x,t_symbol *sym) {
...
// CONSTRUCTOR
void *hmacsha256_new(t_symbol, t_atom argc, t_atom *argv)  
{  
...
{  
  hmacsha256_class = class_new(gensym("hmacsha256"), (t_newmethod)hmacsha256_new, 0, sizeof(t_hmacsha256), A_GIMME, 0);  
 
  class_addsymbol(hmacsha256_class, hmacsha256_symbol); 
}
